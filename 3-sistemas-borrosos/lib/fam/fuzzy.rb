...
module Fam
  class Fuzzy
    ...
    attr_accessor :tempExt, :tempInt,:tempSC, :voltaje, :amperes
    ...
    def tempsincontrol(t)
      if(@puertaAbierta)
        @tempSC << 0.169 * @tempSC.last + 0.831 * @tempExt[t] 
				else
        @tempSC << 0.912 * @tempSC.last + 0.088 * @tempExt[t] 
      end
    end
     ...
     Gnuplot::Plot.new( gp ) do |plot|
      ...
      Gnuplot::DataSet.new( @tempRef ) { |ds|
        ...
        ds.linewidth = 1
			...
			Gnuplot::DataSet.new([ aux, @tempSC] ) { |ds|
        ds.with = "lines"
        ds.linewidth = 1
				ds.title = "Sin-Control"
				},
